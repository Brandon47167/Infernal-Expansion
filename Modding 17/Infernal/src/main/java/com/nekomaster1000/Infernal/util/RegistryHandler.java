...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item> DIMROCKS = ITEMS.register("dimrocks", ItemBase::new);

    // Blocks
    public static final RegistryObject<Block> DIMSTONE = BLOCKS.register("dimstone", Dimstone::new);
    public static final RegistryObject<Block> chiselled_dimstone_brick1 = BLOCKS.register("chiselled_dimstone_brick1", chiselled_dimstone_brick1::new);
